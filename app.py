...
json_path = os.path.join(os.path.dirname(__file__), 'processos.json')
try:
    ...
    fluxogramas = {
        "Setor Financeiro": {
            "Supervisor Financeiro": {
                "Solicitação de Ativação do Cartão Zona Azul": url_for('static', filename='Doc. SolicitaÃ§Ã£o de AtivaÃ§Ã£o do CartÃ£o Zona Azul (2) 27.07.2023 - Luigi Ximenes.png'),
